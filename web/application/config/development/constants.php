...
define('base_url_upload','http://yansen.dev.codigo.id/myr/siprama-recruitment-cms/public_assets/uploads/');
define('base_url_upload_web','http://yansen.dev.codigo.id/myr/siprama-recruitment-web/public_assets/uploads/');
/*
|--------------------------------------------------------------------------
| File Stream Modes
|--------------------------------------------------------------------------
...
define('minh11','400');
define('minx11','400');
define('THUMB_URL','https://thumb.netportal.dev.codigo.id');
