...
define('minh11','400');
define('minx11','400');
define('THUMB_URL','https://thumb.netz.id');
...
CODIGO HEARSAY
**/
define('HEARSAY_BASE_URL','http://api.hearsay.codigo.id/api/');
...
NETCJ
**/
define('BASE_URL_API_NETCJ','admin:1234@api.netcj.co.id/1.0/');
