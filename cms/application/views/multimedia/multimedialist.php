          ...
          <div class="row">
              <div class="col-lg-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">List Multimedia</li>
                </ul>
                <!--breadcrumbs end -->
              </div>
          </div>
               ...
               <section class="panel">
                  <div class="panel-body">
                     <div class="col-lg-15">
                        <!--work progress start-->
                        <section class="panel">
                          <a href="<?php echo site_url('Multimediacms/addmultimedia');?>" class="btn btn-success kanan">Add Multimedia</a>
                           <table class="table table-hover table-bordered personal-task" id="editable-sample">
                              ...
                              <tr>
                                ...
                                <td>
                                 ...
                                 <td>
                                    <form  action="<?php echo base_url() ?>Multimediacms/Operation" method="post">
                                       <input type="hidden" name="MultimediaID" id="MultimediaID" value="<?php echo $r->multimediabank_no; ?>" />
