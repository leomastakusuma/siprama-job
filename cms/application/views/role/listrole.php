              ...
              <div class="panel-body">
                <div class="col-lg-15">
                  ...
                  <div class="adv-table editable-table">
                    <a href="<?php echo site_url('rolecms/Addrole');?>" class="btn btn-success kanan">Add Role</a>
                    ...
                    <table class="table table-striped table-advance table-hover table-bordered" id="example">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="text-center"><?php echo $r->role_id; ?></td>
                          ...
                          <td class="text-center">
                            <form  action="<?php echo base_url() ?>rolecms/edit/<?php echo $r->role_id; ?>"  method="post">
                              <!-- <input type="hidde" > -->
