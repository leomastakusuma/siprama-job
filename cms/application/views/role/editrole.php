...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <form method="post" action="<?php echo site_url("rolecms/update");?>" enctype="multipart/form-data">
                <!-- COL LEFT -->
                <div class="col-xs-9">
                    <!-- Content Article -->
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="position" name="_name" value="<?php echo !empty($_POST['_name']) ? $_POST['_name']: $_name;?>"><span class="has-error"><span class="help-block"> <?php echo form_error('_name');?></span></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="metaTitle" class="col-lg-2 col-sm-2 control-label">Description</label>
                                    <div class="col-lg-8">
                                        <textarea name="_desc" class="form-control"><?php echo !empty($_POST['_desc']) ? $_POST['_desc']: $_desc;?></textarea><span class="has-error"><span class="help-block"> <?php echo form_error('_desc');?></span></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                      ...
                                      <div style="padding:0; display: inline-table; vertical-align: bottom; margin-right: 15px;">
                                          ...
                                          <div class="fileupload2 fileupload-new" data-provides="fileupload">
                                              <div class="fileupload-new thumbnail" style="width: 200px; height: 150px; background: #eee;">
                                                <?php if(!empty($_icon_url)){
                                                    echo '<img  style="width: 190px; height: 140px; width="190" height="140" src="'.$_icon_url.'" />';
                                                }?>
                                              </div>
