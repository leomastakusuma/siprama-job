        ...
        <section class="panel">
              <div class="panel-body">
                <div class="form-horizontal">
                    <section class="panel">
                        <form  action="<?php echo base_url() ?>locationcms/editpropinsi" method="post">
                            ...
                            <div class="col-lg-8">
                              <select class="form-control m-bot15 level" name="negarap">
                                ...
                                <?php foreach($negara as $k=>$baris) :?>
                                   ...
                                   <?php else :?>
                                     <?php if(!empty($_POST['negarap'])&&($_POST['negarap'] == $edit[0]->_location_country_no)):?>
                                       <option value="<?php echo $baris->location_no;?>" selected=""><?php echo $baris->_name ?></option>
                                     <?php else :?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control form_datetime2" name="provinsip"  placeholder="Province" value="<?php echo $edit[0]->_name?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">Name On Gmaps</label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control form_datetime2" name="nameongmapsp"  placeholder="Name On Gmap" value="<?php echo $edit[0]->name_on_gmaps?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">Deskription</label>
                            <div class="col-lg-8">
                                <textarea name="descp" class="form-control" placeholder="Deskription" rows="5" cols="20"><?php echo $edit[0]->_desc ?></textarea>
                            </div>
                          </div>
