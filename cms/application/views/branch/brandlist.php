...
<style>
    .cancelling{
      ...
      <section class="wrapper">
         <h3 class="m-bot15"> Management Brand </h3>
         <div class="row">
            <div class="col-lg-12">
               <!--breadcrumbs start -->
               <ul class="breadcrumb">
                   ...
                   <li class="active">List Branch</li>
               </ul>
               <!--breadcrumbs end -->
            </div>
         </div>
               ...
               <section class="panel">
                  <div class="panel-body">
                     <div class="col-lg-15">
                        <!--work progress start-->
                        <section class="panel">
                          <a href="<?php echo site_url('Managementbrandcms/Addbranch');?>" class="btn btn-success kanan">Add Branch</a>
                                ...
                                <td>
                                 ...
                                 <td>
                                    <form  action="<?php echo base_url() ?>Managementbrandcms/brandOperation" method="post">
                                       <input type="hidden" name="brand_no" id="brand_no" value="<?php echo $r->branch_id; ?>" />
