                            ...
                            <header class="panel-heading">
                              ...
                              <div class="panel-body">
                                <div class="form-horizontal">
                                       <form  action="<?php echo base_url() ?>managementbrandcms/editbranch" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-lg-2 control-label">Corporate Name</label>
                                            <div class="col-lg-8">
                                               <select class="form-control m-bot15" id="level_id" name='corporate'>
                                                 <option value="">Corporate Name</option>
                                                   <?php foreach ($corporate as $row=>$baris) :?>
                                                     <?php if(!empty($_POST['corporate'])):?>
                                                         <?php if($_POST['corporate']==$baris['corporate_id']):?>
                                                           <option selected value="<?php echo $baris['corporate_id']?>"><?php echo $baris['_name']?></option>
                                                         <?php else :?>
                                                           <option value="<?php echo $baris['corporate_id']?>"><?php echo $baris['_name'] ?></option>
                                                         <?php endif;?>
                                                    <?php else :?>
                                                           <?php if($baris['corporate_id'] === $result['corporate_id']):?>
                                                             <option selected value="<?php echo $baris['corporate_id']?>"><?php echo $baris['_name']?></option>
                                                           <?php else: ?>
                                                             <option value="<?php echo $baris['corporate_id']?>"><?php echo $baris['_name']?></option>
                                                          <?php endif;?>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-lg-8">
                                             <input type="hidden" class="form-control" id="brand_no" name="brand_no" value="<?php echo $result['branch_id']?>"  placeholder="Brand name" required maxlength="59">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <textarea name="desc" class="form-control" placeholder="Description"><?php echo $result['_desc']?></textarea>
                                            </div>
                                        </div>
      								                  <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="pic_name" name="pic_name"  placeholder="PIC Name"  value="<?php echo $result['_pic_name']?>" required maxlength="24">
                                            </div>
                                        </div>
      								                  <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">PIC Email</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="pic_phone" name="pic_email"  placeholder="PIC Email"  value="<?php echo $result['_pic_email']?>" required maxlength="44">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">PIC Phone</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="pic_phone" name="pic_phone"  placeholder="PIC Phone"  value="<?php echo $result['_pic_phone']?>"required maxlength="44">
                                            </div>
                                        </div>
                                        <div class="form-group">
