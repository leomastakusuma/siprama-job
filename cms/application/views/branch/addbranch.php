                            ...
                            <header class="panel-heading">
                              ...
                              <div class="panel-body">
                                <div class="form-horizontal">
                                       <form  action="<?php echo base_url() ?>managementbrandcms/Addbranch" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="pic_name" name="pic_name"  placeholder="PIC Name" required maxlength="24">
                                            </div>
                                        </div>
      								                  <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">PIC Email</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="pic_phone" name="pic_email"  placeholder="PIC Email" required maxlength="44">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">PIC Phone</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="pic_phone" name="pic_phone"  placeholder="PIC Phone" required maxlength="44">
                                            </div>
                                        </div>
                                        <div class="form-group">
