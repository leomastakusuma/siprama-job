               ...
               <section class="panel">
                  <div class="panel-body">
                     <div class="col-lg-15">
                        <!--work progress start-->
                        <section class="panel">
                          <a href="<?php echo site_url('corporatecms/addcorporate');?>" class="btn btn-success kanan">Add Corporate</a>
                           <table class="table table-hover table-bordered personal-task" id="editable-sample">
                              ...
                              <tr>
                                ...
                                <td>
                                 ...
                                 <td>
                                    <form  action="<?php echo base_url() ?>Corporatecms/brandOperation" method="post">
                                       <input type="hidden" name="corporate_id" id="corporate_id" value="<?php echo $r->corporate_id; ?>" />
