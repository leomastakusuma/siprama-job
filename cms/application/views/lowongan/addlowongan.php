                            ...
                            <header class="panel-heading">
                              ...
                              <div class="panel-body">
                                <div class="form-horizontal">
                                       <form  action="<?php echo base_url() ?>lowongancms/addlowongan" method="post">
                                           ...
                                           <div class="col-lg-8">
                                             <select class="form-control m-bot15 lokasi" name="lokasikota">
                                               ...
                                               <?php foreach($kota as $k=>$baris) :?>
                                                    <?php if(!empty($_POST['lokasikota'])&&($_POST['lokasikota'] == $baris->location_no)):?>
                                        ...
                                        <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">Star Date</label>
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control form_datetime2" id="from" name="datefrom"  placeholder="Start Date" value="<?php echo !empty($_POST['datefrom']) ? $_POST['datefrom'] : '';?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">End Date</label>
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control form_datetime2" id="datethru" name="datethru" placeholder="End Date" value="<?php echo !empty($_POST['datethru']) ? $_POST['datethru'] : '';?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">Description</label>
                                            <div class="col-lg-8">
                                                <textarea name="desc" class="form-control" placeholder="Description" rows="10" cols="20"><?php echo !empty($_POST['desc']) ? $_POST['desc'] : ''?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">Persyaratan</label>
                                            <div class="col-lg-8">
                                                <textarea name="persyaratan" class="form-control" placeholder="Persyaratan" rows="10" cols="20"><?php echo !empty($_POST['persyaratan']) ? $_POST['persyaratan'] : ''?></textarea>
                                            </div>
                                        </div>
