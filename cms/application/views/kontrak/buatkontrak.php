               ...
               <section class="panel">
                  <div class="panel-body">
                     <div class="col-lg-12">
                        ...
                        <section class="panel">
                          <div class="row">
                            <header class="panel-heading">Info Pelamar</header>
                                  ...
                                  <div class="form-group">
                                       ...
                                       <div>
                                         <div class="col-lg-4">
                                           <div class="row">
                                             <div class="col-lg-5">
                                               <input type="text" class="form-control form_datetime2 priodeawal" name="priodeawal" value="<?php echo (!empty($_POST['priodeawal']) ? $_POST['priodeawal'] : '');?>"id="priodeawal" placeholder="Priode Awal">
                                             </div>
                                             <label for="setLocation" class="col-lg-2 col-sm-1 control-label">s/d</label>
                                             <div class="col-lg-5">
                                               <input type="text" class="form-control form_datetime2 priodeakhir" name="priodeakhir" id="priodeakhir" placeholder="Priode Akhir" value="<?php echo (!empty($_POST['priodeakhir']) ? $_POST['priodeakhir'] : '');?>">
                                             </div>
                                           </div>
                                         </div>
                                       </div>
                        ...
                        <section class="panel">
                          <div class="row">
                            ...
                            <div class="row text-center">
                              <button class="btn btn-primary" name="Submit" value="Submit" onclick="return submitKontrak()">Submit</button>
                            </div>
...
<?php include($includes . "/footer-notif-general.php"); ?>
    ...
    <script src="<?php echo $js;?>jquery.cookie.js"></script>
      ...
      function submitKontrak(){
          ...
          var tempKontrak = '<?php echo $idKontrakTemp;?>';
          if(tipe =='CTGLWGN01'){
              if(rincian == ''){
                  ...
                  ({
                      type: "POST",
                      url: "<?php echo site_url('kontrak/ajaxKontrak');?>",
                      data: {"priodeawal":priodeawal,"priodeakhir":priodeakhir,"typelowongan" :  typelowongan, "idLowongan":idLowongan,"tempKontrak":tempKontrak},
                      cache: false,
                      success: function (html) {
                          console.log(html);
      ...
      function submitForm(){
          ...
          if(tipe == '' || jumlah ==''){
              ...
              ({
                  ...
                  data: {"tipe":tipe,"jumlah":jumlah,"tempKontrak" :  tempKontrak, "idLowongan":idLowongan},
                  cache: false,
                  success: function (html) {
                      console.log(html);
                       window.location.reload();
