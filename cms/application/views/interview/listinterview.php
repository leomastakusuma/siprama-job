    ...
    .cancelling{
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3 class="m-bot15"> Interview </h3>
          <div class="row">
              <div class="col-lg-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li><a href="<?php echo site_url()?>"><i class="icon-home"></i> Home</a></li>
                    <li><a href="<?php echo site_url('Interviewclientcms')?>">List Interview</a></li>
                </ul>
                <!--breadcrumbs end -->
              </div>
          </div>
                           ...
                           <table class="table table-hover table-bordered personal-task" id="editable-sample">
                              <thead>
                                 <tr>
                                    ...
                                    <th>Nama Pelamar</th>
                                    <th>Status</th>
                                    <th align="center" width="300px" >Action</th>
                                 </tr>
                              </thead>
		                          <tbody>
                              ...
                              <?php foreach($result  as $r): ?>
                                <tr>
                                  <td><?php echo $r->interview_no;?></td>
                                  <td><?php echo $r->lowongan_posisi;?></td>
                                  <td><?php echo $r->lowongan_name;?></td>
                                  <td><?php echo $r->namalengkap;?></td>
                                  <td><?php echo $r->status_interview_name;?></td>
                                  <td align="center">
                                      <a href="<?php echo site_url('Interviewcms/detail').'/'.$r->apply_lowongan_no;?>" class="btn btn-warning clicking">Lihat Detail</a>
                                      <?php if($r->status_interview_id === "STATUSINT00") :?>
                                          <a href="<?php echo site_url('Interviewcms/tindak').'/'.$r->apply_lowongan_no;?>" class="btn btn-success clicking">Tindak Lanjut</a>
                                      <?php endif;?>
                                 </td>
                                </tr>
                              <?php endforeach; ?>
