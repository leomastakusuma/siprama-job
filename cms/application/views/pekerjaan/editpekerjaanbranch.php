...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Edit Pekerjaan Branch </li>
                    </ul>
                    <!--breadcrumbs end -->
            </div>
        </div>
        ...
        <div class="row">
            <form method="post" action="<?php echo site_url("pekerjaancms/editpekerjaanbranch");?>" enctype="multipart/form-data">
                <!-- COL LEFT -->
                <div class="col-xs-9">
                    <!-- Content Article -->
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <input type="hidden" value="<?php echo $result->pekerjaan_branch_no?>" name="pekerjaanBranchID">
                                         ...
                                         <option value="">Select Branch</option>
                                           <?php foreach ($branch as $row=>$baris) :?>
                                             <?php if(!empty($_POST['branch'])):?>
                                                 ...
                                                 <?php endif;?>
                                            <?php else :?>
                                                    <?php if($result->branch_id===$baris->branch_id):?>
                                                        <option selected value="<?php echo $baris->branch_id?>"><?php echo $baris->_name?></option>
                                                    <?php  else:  ?>
                                                        <option value="<?php echo $baris->branch_id?>"><?php echo $baris->_name?></option>
                                                   <?php endif;?>
                                         ...
                                         <option value="">Select Pekerjaan</option>
                                           <?php foreach ($pekerjaan as $row=>$baris) :?>
                                             <?php if(!empty($_POST['pekerjaan'])):?>
                                                 ...
                                                 <?php endif;?>
                                            <?php else :?>
                                                  <?php if($result->pekerjaan_id === $baris->pekerjaan_id):?>
                                                    <option selected value="<?php echo $baris->pekerjaan_id?>"><?php echo $baris->_name?></option>
                                                  <?php else: ?>
                                                    <option value="<?php echo $baris->pekerjaan_id?>"><?php echo $baris->_name?></option>
                                                  <?php endif;?>
