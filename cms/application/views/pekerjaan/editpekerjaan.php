                ...
                <div class="col-xs-9">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                          <form method="post" action="<?php echo site_url("pekerjaancms/editpekerjaan");?>" enctype="multipart/form-data">
                            <div class="form-horizontal">
                                         ...
                                         <option value="">None</option>
                                           <?php foreach ($pekerjaan as $row=>$baris) :?>
                                             <?php if(!empty($_POST['parent'])):?>
                                                 ...
                                                 <?php endif;?>
                                            <?php else :?>
                                                   <?php if($r->_parent_pekerjaan_id===$baris->pekerjaan_id):?>
                                                     <option selected value="<?php echo $baris->pekerjaan_id?>"><?php echo $baris->_name?></option>
                                                   <?php else :?>
                                                      <option value="<?php echo $baris->pekerjaan_id?>"><?php echo $baris->_name?></option>
                                                    <?php endif;?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <input type="text" class="form-control" id="position" name="name" value="<?php echo (!empty($r->_name) ? $r->_name : (!empty($_POST['_name']) ? $_POST['_name']: null));?>">
                                    </div>
                                </div>
                                <div class="form-group">
