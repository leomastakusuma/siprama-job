              ...
              <div class="panel-body">
                <div class="col-lg-15">
                  ...
                  <div class="adv-table editable-table">
                    <a href="<?php echo site_url('pekerjaancms/addpekerjaan');?>" class="btn btn-success kanan">Add Pekerjaan</a>
                    ...
                    <table class="table table-striped table-advance table-hover table-bordered" id="example">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <!-- <td class="text-center"><?php #echo $r->parent_name; ?></td> -->
                          ...
                          <td class="text-center">
                            <form  action="<?php echo base_url() ?>pekerjaancms/operation"  method="post">
                              <input type="hidden" name="pekerjaanID" value="<?php echo $r->pekerjaan_id?>">
                              <button type="submit" name="edit" method="edit" class="btn btn-warning clicking"value="edit" ><i class="fa fa-pencil-square-o"></i> Edit</button>
                              <?php $status = $r->_active; ?>
                              <?php if ($status == "1"): ?>
                              <button type="submit" name="set_active" method="set_nonactive" value="set_nonactive" style='float:none' class="btn btn-success clicking" ><i class="fa fa-check"></i> Active</button>
                              <button type="submit" name="delete" method="set_active" value="set_active"style='float:none'class="btn btn-danger clicking" onclick="return confirm('Yakin Akan Menghapus Pekerjaan ?');" ><i class="fa fa-times"></i> Delete</button>

                              <?php endif; ?>
                              <?php if ($status == "0") : ?>
                              <button type="submit" name="set_nonactive" method="set_active" value="set_active"style='float:none'class="btn btn-danger clicking" ><i class="fa fa-times"></i> Non Active</button>
                              <?php endif; ?>
                            </form>
                          </td>
                        </tr>
