    ...
    .cancelling{
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3 class="m-bot15"> List Interview Client</h3>
          <div class="row">
              <div class="col-lg-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li><a href="<?php echo site_url()?>"><i class="icon-home"></i> Home</a></li>
                    <li><a href="<?php echo site_url('Interviewcms')?>">List Interview Client</a></li>
                </ul>
                <!--breadcrumbs end -->
              </div>
          </div>
                           ...
                           <table class="table table-hover table-bordered personal-task" id="editable-sample">
                              ...
                              <?php foreach($result  as $r): ?>
                                <tr>
                                  ...
                                  <td><?php echo $r->status_interview_client_name;?></td>
                                  <td align="center">
                                      <a href="<?php echo site_url('Interviewclientcms/detail').'/'.$r->apply_lowongan_no;?>" class="btn btn-warning clicking">Lihat Detail</a>
                                      <?php if($r->status_interview_client_id === "STATUSINTCL00") :?>
                                          <a href="<?php echo site_url('Interviewclientcms/tindak').'/'.$r->apply_lowongan_no;?>" class="btn btn-success clicking">Tindak Lanjut</a>
                                      <?php endif;?>
                                 </td>
                                </tr>
                              <?php endforeach; ?>
