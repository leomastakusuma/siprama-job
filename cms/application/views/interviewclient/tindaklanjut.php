...
<style>
    .cancelling{
      ...
      <section class="wrapper">
        <h3 class="m-bot15"> Tindak Lanjut Interview Client </h3>
        <div class="row">
            <div class="col-lg-12">
              <!--breadcrumbs start -->
              <ul class="breadcrumb">
                  ...
                  <li class="active">Tindak Lanjut Interview Client</li>
              </ul>
              <!--breadcrumbs end -->
            </div>
        </div>
                          ...
                          <div class="panel-body">
                            <div class="form-horizontal">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <?php echo $interview->_analisa_interview;?>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                      <?php if($interview->interview_client_no === "INTERVIEWCL00000001102016") :?>
                                        <input type="text" class="form-control" readonly value="-"  >
                                      <?php else :?>
                        ...
                        <section class="panel">
                          ...
                          <div class="row">
                            <div class="col-sm-12" align="center">
                              <div class="form-horizontal">
                                     <form  action="<?php echo base_url() ?>Interviewclientcms/tindaklanjut" method="post" enctype="multipart/form-data">
                                       <input type="hidden" value="<?php echo $interview->pelamar_no?>" name="pelamar_no">
                                       <input type="hidden" value="<?php echo $interview->interview_client_no;?>" name="interview_client_no">
