                            ...
                            <header class="panel-heading">
                              ...
                              <div class="panel-body">
                                <div class="form-horizontal">
                                       <form  action="<?php echo base_url() ?>clientcms/editclient" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                          <label for="setLocation" class="col-lg-2 col-sm-2 control-label">Name</label>
                                          <div class="col-lg-8">
                                             <input type="hidden" class="form-control" id="clientID" name="clientID" value="<?php echo $result['client_id']?>">

                                              <input type="text" class="form-control" id="name" name="name" value="<?php echo !empty($_POST['name'])  ?  $_POST['name']  : $result['_name'] ?>"  placeholder="Brand name" required maxlength="59">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="address" name="address"  value="<?php echo !empty($_POST['address'])  ?  $_POST['address']  : $result['_address']?>" placeholder="Address" required maxlength="244">
                                            </div>
                                        </div>
      								                  <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">Phone</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone" onkeypress="return isNumberKey(event)"  value="<?php echo !empty($_POST['phone'])  ?  $_POST['phone']  : $result['_phone']?>"required maxlength="24">
                                            </div>
                                        </div>
      								                  <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">PIC Name</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="pic_name" name="pic_name"  placeholder="PIC Name"  value="<?php echo !empty($_POST['pic_name'])  ?  $_POST['pic_name']  : $result['_pic_name']?>" required maxlength="24">
                                            </div>
                                        </div>
      								                  <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">PIC Email</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="pic_phone" name="pic_email"  placeholder="PIC Email"  value="<?php echo !empty($_POST['pic_email'])  ?  $_POST['pic_email']  : $result['_pic_email']?>" required maxlength="44">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">PIC Phone</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="pic_phone" name="pic_phone" onkeypress="return isNumberKey(event)" placeholder="PIC Phone"  value="<?php echo !empty($_POST['pic_phone'])  ?  $_POST['pic_phone']  : $result['_pic_phone']?>"required maxlength="44">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                  ...
                                                  <div class="fileupload2 fileupload-new" data-provides="fileupload">
                                                      <div class="fileupload-new thumbnail" style="width: 350px; height: 250px; background: #eee;">
                                                        <?php if(!empty($result['_logo_url'])){
                                                            echo '<img  style="width: 340px; height: 240px; width="340" height="240" src="'.$result['_logo_url'].'" />';
                                                        }?>
                                                      </div>
