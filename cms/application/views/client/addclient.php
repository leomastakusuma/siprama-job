                                ...
                                <div class="form-horizontal">
                                       <form  action="<?php echo base_url() ?>Clientcms/Addclient" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                          ...
                                          <div class="col-lg-8">
                                              <input type="text" class="form-control" id="name" name="name"  placeholder="Client name" value="<?php echo !empty($_POST['name']) ? $_POST['name'] : '';?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="address" name="address"  placeholder="Address" value="<?php echo !empty($_POST['address']) ? $_POST['address'] : '';?>">
                                            </div>
                                        </div>
      								                  <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">Phone</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control"  onkeypress="return isNumberKey(event)" id="phone" name="phone" placeholder="Phone" value="<?php echo !empty($_POST['phone']) ? $_POST['phone'] : '';?>">
                                            </div>
                                        </div>
      								                  <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">PIC Name</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="pic_name" name="pic_name"  placeholder="PIC Name" value="<?php echo !empty($_POST['pic_name']) ? $_POST['pic_name'] : '';?>" >
                                            </div>
                                        </div>
      								                  <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">PIC Email</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="pic_phone" name="pic_email"  placeholder="PIC Email" value="<?php echo !empty($_POST['pic_email']) ? $_POST['pic_email'] : '';?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="setLocation" class="col-lg-2 col-sm-2 control-label">PIC Phone</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" onkeypress="return isNumberKey(event)" id="pic_phone" name="pic_phone"  placeholder="PIC Phone" value="<?php echo !empty($_POST['pic_phone']) ? $_POST['pic_phone'] : '';?>">
                                            </div>
                                        </div>
