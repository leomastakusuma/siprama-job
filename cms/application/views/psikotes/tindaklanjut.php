                        ...
                        <section class="panel">
                          ...
                          <div class="row">
                            <div class="col-sm-12" align="center">
                              <div class="form-horizontal">
                                     <form  action="<?php echo base_url() ?>Psikotescms/tindaklanjut" method="post" enctype="multipart/form-data">
                                       <input type="hidden" value="<?php echo $psikotes->psikotes_no?>" name="psikotes_no">
                                       <input type="hidden" value="<?php echo $psikotes->pelamar_no?>" name="pelamar_no">
                                       <input type="hidden" value="<?php echo $psikotes->apply_lowongan_no;?>" name="lowongan_no">



                                        <div class="form-group">
                                          <label for="setLocation" class="col-lg-2 col-sm-2 control-label">Status</label>
                                          <div class="col-lg-8">
