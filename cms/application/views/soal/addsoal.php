               ...
               <section class="panel">
                <header class="panel-heading">Soal Information</header>
                  <div class="panel-body">
                     <div class="col-lg-12">
                        <section class="panel">
                           <form class='form-horizontal' action="<?php echo base_url() ?>soalcms/addsoal" method="post" enctype="multipart/form-data">
                               ...
                               <div class="form-group" >
                                   ...
                                   <div class="col-sm-9">
                                       <textarea class="form-control" rows="5"  name="pertanyaan"><?php echo !empty($_POST['pertanyaan']) ? $_POST['pertanyaan'] : '' ;?></textarea>
                                   </div><!-- /.input group -->
                               </div><!-- /.form group -->
                               <div class="form-group" >
                                   <label class="col-sm-2 control-label">Opsi A</label>
                                     <div class="col-xs-7">
                                       <textarea class="form-control" name="opsia" cols="2" rows="2"><?php echo !empty($_POST['opsia']) ? $_POST['opsia'] : '' ?></textarea>
                                       <!-- <input type="text" class="form-control"  placeholder="" name="opsia">                                -->
                                     </div>
                                     <div class="col-xs-2">
                                        <input type="number" class="form-control" placeholder="Nilai" name="nilaia"  value="<?php echo !empty($_POST['nilaia']) ? $_POST['nilaia'] : '' ?>"onkeypress="return isNumberKey(event)" min="1" max="100" maxlength="3" step="0.01">
                                     </div>
                                </div><!-- /.form group -->
                                  ...
                                  <div class="form-group" >
                                     <label class="col-sm-2 control-label">Opsi B</label>
                                       <div class="col-xs-7">
                                         <textarea class="form-control" name="opsib" cols="2" rows="2"><?php echo !empty($_POST['opsib']) ? $_POST['opsib'] : '' ?></textarea>
                                         <!-- <input type="text"   placeholder=""> -->
                                       </div>
                                       <div class="col-xs-2">
                                         <input type="number" class="form-control" placeholder="Nilai" name="nilaib" value="<?php echo  !empty($_POST['nilaib']) ? $_POST['nilaib'] : '' ?>"onkeypress="return isNumberKey(event)" min="1" max="100" maxlength="3"  step="0.01">
                                       </div>
                                 </div><!-- /.form group -->
                                  ...
                                  <div class="form-group" >
                                     <label class="col-sm-2 control-label">Opsi C</label>
                                       <div class="col-xs-7">
                                         <textarea class="form-control" name="opsic" cols="2" rows="2"><?php echo !empty($_POST['opsic']) ? $_POST['opsic'] : '' ?></textarea>
                                         <!-- <input type="text" class="form-control" placeholder="" name="opsic"> -->
                                       </div>
                                       <div class="col-xs-2">
                                         <input type="number" class="form-control" placeholder="Nilai" name="nilaic" value="<?php echo  !empty($_POST['nilaic']) ? $_POST['nilaic'] : '' ?>" onkeypress="return isNumberKey(event)" min="1" max="100" maxlength="3"  step="0.01">
                                       </div>
                                 </div>
                                  ...
                                  <div class="form-group" >
                                     <label class="col-sm-2 control-label">Opsi D</label>
                                       <div class="col-xs-7">
                                         <textarea class="form-control" name="opsid" cols="2" rows="2"><?php echo !empty($_POST['opsid']) ? $_POST['opsid'] : '' ?></textarea>
                                         <!-- <input type="text" class="form-control"   placeholder="" name="opsid"> -->
                                       </div>
                                       <div class="col-xs-2">
                                         <input type="number" class="form-control"  placeholder="Nilai" name="nilaid" value="<?php echo  !empty($_POST['nilaid']) ? $_POST['nilaid'] : '' ?>"onkeypress="return isNumberKey(event)" min="1" max="100" maxlength="3"  step="0.01">
                                       </div>
                                 </div>
