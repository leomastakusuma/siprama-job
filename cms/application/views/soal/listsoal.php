              ...
              <div class="panel-body">
                <div class="col-lg-15">
                  ...
                  <div class="adv-table editable-table">
                    <a href="<?php echo site_url('soalcms/addsoal');?>" class="btn btn-success kanan">Add Soal</a>
                    ...
                    <table class="table table-striped table-advance table-hover table-bordered" id="example">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="text-center"><?php echo substr($r->_pertanyaan,0,50); ?>...</td>
                          <td class="text-center"><?php echo $r->kategori_soal; ?></td>
                          ...
                          <td class="text-center"><?php echo $r->create_date; ?></td>
                          <td class="text-center"><?php echo $r->_full_name; ?></td>
                          <td class="text-center">
                            <form  action="<?php echo base_url() ?>Soalcms/operation/<?php echo $r->soal_id; ?>"  method="post">
                                <input type="hidden" name="soalid" value="<?php echo $r->soal_id?>">
                                <?php if($r->_active == "1") :?>
                                  <button type="submit" name="delete"  value="delete" class="btn btn-danger clicking" onclick="return confirm('Yakin Akan Menghapus Soal ?');" ><i class="fa fa-pencil-square-o"></i> Delete</button>
                                <?php endif;?>
                                <button type="submit" name="edit"  value="edit"class="btn btn-warning clicking" ><i class="fa fa-pencil-square-o"></i> Edit</button>
                                <?php if ($r->_active=="1") :?>
                                  <button type="submit" name="setinactive"  value="setinactive" class="btn btn-success clicking" ><i class="fa fa-pencil-square-o"></i> Active</button>
                                <?php else : ?>
                                  <button type="submit" name="setactive" value="setactive" class="btn btn-danger clicking" ><i class="fa fa-pencil-square-o"></i> Non Active</button>
                                <?php endif;?>
                            </form>
                          </td>
                        </tr>
