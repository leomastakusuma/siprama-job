		...
		<center>
			<div class="main_container">
				...
				<div class="width-100 border-bottom-double">
					...
					<div class="width-79 text-24px text-right PT-25px height-35 ">LAPORAN LOWONGAN</div>
				</div>
				...
				<div class="width-100">
						...
						<div class="width-100 MT-10px ">
							<table class="text-11px width-100" border=1 cellpadding=4>
								...
								<tbody>
										<?php $n= 0;?>
										<?php foreach ($lowongan as $key => $value) :$n++;?>
												<tr>
														<td><?php echo $n;?></td>
														<td><?php echo $value->klien ;?></td>
														<td><?php echo $value->pekerjaanname ;?></td>
														<td><?php echo $value->_name ;?></td>
														<td><?php echo $value->_date_from.' s/d '.$value->_date_thru ;?></td>
												</tr>
				...
				<!-- <input type="button" name="Cetak" value="Cetak" class="btn btn-default pull-right" id="cetak" onclick="return cetak()"> -->
				<div class="clear"></div>
